...
def main():
    ...
    # Define paths
    root = args.folder
    backgrounds_folder = os.path.join(root,'backgrounds/sides')
    target_image_path = os.path.join(root,'target.png')  # The image with transparency
    target2_image_path = os.path.join(root,'target2.png')  # The image with transparency
    ...
    save_path = os.path.join(root, 'one_shot_object_detector_5x3_SIDES.pth')
